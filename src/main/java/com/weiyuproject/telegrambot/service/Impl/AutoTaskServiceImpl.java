...
public class AutoTaskServiceImpl implements AutoTaskService {
    ...
    @Override
    @Scheduled(cron = "0 0 8 * * ?", zone = "GMT+6")
    ...
    @Override
    @Scheduled(cron = "0 0 8 * * ?", zone = "GMT+9")
    ...
    @Override
    @Scheduled(cron = "0 0 8 * * ?", zone = "GMT+10")
    ...
    @Override
    @Scheduled(cron = "0 0 8 * * ?", zone = "GMT+11")
    ...
    @Override
    @Scheduled(cron = "0 0 8 * * ?", zone = "GMT+12")
    ...
    @Override
    @Scheduled(cron = "0 0 8 * * ?", zone = "GMT-13")
    ...
    @Override
    @Scheduled(cron = "0 0 8 * * ?", zone = "GMT-14")
